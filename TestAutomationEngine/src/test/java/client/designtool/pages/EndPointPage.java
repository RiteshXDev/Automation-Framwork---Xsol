...
public class EndPointPage extends WebBaseTest {
    public EndPointPage() {
    ...
    @FindBy(xpath = "//button[@class='flex items-center gap-2 px-4 py-2 bg-[#003366] border border-transparent rounded-lg text-sm font-semibold text-white hover:bg-[#002244] transition-colors shadow-sm']")
    ...
    @FindBy(xpath = "//button[contains(@title,'Mark this leaf node as a confirmed end point to clear the review flag.')]")
    public WebElement endPointTickBox;

    @FindBy(xpath = "//span[@class='text-sm leading-snug text-blue-600 '][normalize-space()='node4']")
    public WebElement node4Button;

    @FindBy(xpath = "(//span[@class='ml-2 text-[9px] font-semibold text-emerald-700 bg-emerald-100 border border-emerald-300 px-1.5 py-0.5 rounded-full shrink-0'])[3]")
    public WebElement node4_leftPanel;
