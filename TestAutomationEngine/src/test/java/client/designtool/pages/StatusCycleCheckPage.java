...
public class StatusCycleCheckPage
{
    public StatusCycleCheckPage()
    {
    ...
    @FindBy(xpath = "//*[@id=\"root\"]/div/div/div/div/aside[2]/div/div/div[2]/div/div/div[2]/div[3]/div/div[3]/button[2]")
    public WebElement addAlertRemoveButton;

    @FindBy(xpath = "//*[@id=\"root\"]/div/div/div/div/aside[2]/div/div/div[2]/div/div/div[3]/div/button")
    public WebElement addStepSnippetButton;

    @FindBy(xpath = "//*[@id=\"root\"]/div/div/div/div/aside[2]/div/div/div[2]/div/div/div[3]/ul/li/div/div[3]/button[2]")
    public WebElement addStepRemoveButton;

    @FindBy(xpath = "//*[@id=\"root\"]/div/div/div/div/aside[2]/div/div/div[2]/div/div/div[4]/div/button")
    public WebElement addInstructionSnippetButton;

    @FindBy(xpath = "//*[@id=\"root\"]/div/div/div/div/aside[1]/div[1]/div/div[2]/div/div/button")
    public WebElement statusChangeDropDownMenu;

    @FindBy(xpath = "//span[normalize-space()='READY FOR REVIEW']")
    public WebElement readyForReviewButton;

    @FindBy(xpath = "//*[@id=\"root\"]/div/div/div/div[1]")
    public WebElement waitingForReviewYellowBar;

    @FindBy(xpath = "//*[@id=\"root\"]/div/div/div/div[2]/div/div/button[1]")
    public WebElement sendForReviewButton;

    @FindBy(xpath = "//*[@id=\"root\"]/div/div/div/div[4]/div/div[2]/button[2]")
    public WebElement continueViewingButton;

    @FindBy(xpath = "//span[normalize-space()='IN REVIEW']")
    public WebElement inReviewButton;

    @FindBy(xpath = "//span[normalize-space()='READY FOR PUBLISH']")
    ...
    @FindBy(xpath = "//span[@class='text-sm font-mono font-semibold flex-1 text-slate-300 italic font-normal cursor-text hover:bg-white rounded px-1 -mx-1 transition-colors']")
    ...
    @FindBy(xpath = "//button[.//*[contains(@class,'lucide-trash2')]]")
